...
class AppTextCatalog {
  ...
  static const Map<AppLanguage, Map<String, String>> _values = {
    AppLanguage.russian: {
      ...
      'status.runtime_status_waiting': 'ожидание данных',
      ...
      'label.config': 'конфиг',
      'label.runtime_status': 'статус runtime',
    ...
    AppLanguage.english: {
      ...
      'status.runtime_status_waiting': 'waiting for data',
      ...
      'label.config': 'config',
      'label.runtime_status': 'runtime status',
