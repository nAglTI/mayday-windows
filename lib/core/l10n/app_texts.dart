  ...
  static const Map<AppLanguage, Map<String, String>> _values = {
    AppLanguage.russian: {
      ...
      'message.vpn_scan_blocked':
          'Подключение заблокировано: найдены нежелательные приложения ({count}).',
      ...
      'title.vpn_scan_blocked_body':
          'Mayday не будет запускать VPN, пока на компьютере найдены приложения, exe-файлы, службы или автозадачи из списка блокировки.',
    ...
    AppLanguage.english: {
      ...
      'message.vpn_scan_blocked':
          'Connection blocked: blocked apps were found ({count}).',
      'message.vpn_scan_failed':
      ...
      'title.vpn_scan_blocked_body':
          'Mayday will not start the VPN while blocked apps, exe files, services, or scheduled tasks are present on this computer.',
      'title.split_disabled_hint':
