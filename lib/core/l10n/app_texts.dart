...
class AppTextCatalog {
  ...
  static const Map<AppLanguage, Map<String, String>> _values = {
    AppLanguage.russian: {
      ...
      'status.scan_clear': 'рисков не найдено',
      ...
      'message.vpn_scan_blocked':
          'Подключение заблокировано: найдены приложения с признаками VPN/proxy discovery ({count}).',
      'message.vpn_scan_failed':
          'Не удалось проверить приложения перед подключением: {error}',
      'message.vpn_scan_clear':
          'Проверка завершена: приложения с признаками VPN/proxy discovery не найдены.',
      ...
      'title.vpn_scan_blocked': 'Подключение заблокировано',
      'title.vpn_scan_blocked_body':
          'Mayday не будет запускать VPN, пока на компьютере найдены приложения с признаками поиска VPN/proxy/Tor.',
      ...
      'label.vpn_scan_score': 'риск',
      'label.vpn_scan_signals': 'признаки',
      'label.vpn_scan_exe_candidates': 'exe-кандидаты',
    ...
    AppLanguage.english: {
      ...
      'message.vpn_scan_blocked':
          'Connection blocked: apps with VPN/proxy discovery signals were found ({count}).',
      'message.vpn_scan_failed':
          'Failed to scan apps before connecting: {error}',
      'message.vpn_scan_clear':
          'Scan complete: no apps with VPN/proxy discovery signals were found.',
      'message.pid_suffix': ' PID: {pid}.',
      ...
      'title.vpn_scan_blocked': 'Connection blocked',
      'title.vpn_scan_blocked_body':
          'Mayday will not start the VPN while apps with VPN/proxy/Tor discovery signals are present on this computer.',
      'title.split_disabled_hint':
      ...
      'label.vpn_scan_score': 'risk',
      'label.vpn_scan_signals': 'signals',
      'label.vpn_scan_exe_candidates': 'exe candidates',
      'tooltip.move': 'Move',
